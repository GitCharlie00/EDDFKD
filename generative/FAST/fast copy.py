...
class FAST():
    def __init__(self,args,teacher,student,G,history,W,opt_S,transform,save_dir):
        ...
        self.opt_G = torch.optim.Adam(self.G.parameters(), self.lr_g*self.iterations)
    ...
    def update_G(self,epoch):
        ...
        for _ in gen_bar:
            ...
            if self.ood_loss:
                ...
                if self.additive_loss:
                    ...
                    loss_G = self.ood_gamma * loss_energy + self.oh * loss_oh + self.adv * loss_adv + self.feat * loss_feat
        ...
        train_sampler = None
        loader = torch.utils.data.DataLoader(dst, batch_size=self.sample_batch_size, shuffle=(train_sampler is None), num_workers=4, pin_memory=True, sampler=train_sampler)
