    ...
    if args.mode == "train":
        ...
        if args.method.lower() == "dafl":
            if args.dataset == "cifar10":
                ...
                z_dim            = 1000 #512
                epochs           = 2000 #250
                lr_G             = args.lr_G if args.lr_G is not None else 0.02   # original DAFL CIFAR-10
                lr_S             = 0.1
                oh               = args.oh if args.oh is not None else 1.0
                act              = args.act if args.act is not None else 0.1      # original DAFL --a
                ie               = args.ie if args.ie is not None else 5          # original DAFL --ie
                kd_steps         = 1    #5
                ep_steps         = 120  #400
                ...
                z_dim            = 1000
                epochs           = 2000
                lr_G             = args.lr_G if args.lr_G is not None else 0.02   # original DAFL CIFAR-100
                lr_S             = 0.1
                oh               = args.oh if args.oh is not None else 0.5        # original DAFL CIFAR-100 --oh
                act              = args.act if args.act is not None else 0.1      # original DAFL --a
                ie               = args.ie if args.ie is not None else 20         # original DAFL CIFAR-100 --ie
                kd_steps         = 1
                ep_steps         = 120 
