# WideResNet for CIFAR from https://github.com/polo5/ZeroShotKnowledgeTransfer/blob/master/models/wresnet.py 
...
class WideResNet(nn.Module):
    def __init__(self, depth, num_classes, widen_factor=1, dropout_rate=0.0, feature_extractor=False):
...
def wrn_40_2(num_classes, dropout_rate=0, feature_extractor=False):
    return WideResNet(depth=40, num_classes=num_classes, widen_factor=2, dropout_rate=dropout_rate, feature_extractor=feature_extractor)