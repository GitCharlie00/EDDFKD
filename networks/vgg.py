# VGG for CIFAR-10 from https://github.com/HobbitLong/RepDistiller/blob/master/models/vgg.py
...
class VGG11(nn.Module):
    def __init__(self, cfg=cfg['A'], batch_norm=False, num_classes=1000, feature_extractor=False):
